const data = {
  id: "proposals",
  title: "A Better Huntsville: The Blueprint for Change",
  intro: "Show how different policy choices could change outcomes in Madison County for the better.",
  tabs: [
    {
      id: "overview",
      label: "Overview",
      ...
      issues: [
        {
          id: "in_progress",
          label: "In Progress",
          title: "A Better Huntsville: The Blueprint for Change is being rebuilt",
