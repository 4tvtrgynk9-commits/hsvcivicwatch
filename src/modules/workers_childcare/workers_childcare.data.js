const data = {
  ...
  title: "Workers Rights & Child Care",
  intro: "Track workplace rights, low-wage conditions, child care burdens, and how they reinforce each other.",
  tabs: [
    {
      id: "overview",
      label: "Overview",
      ...
      issues: [
        {
          id: "in_progress",
          label: "In Progress",
          title: "Workers Rights & Child Care is being rebuilt",
