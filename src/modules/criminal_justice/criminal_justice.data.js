const data = {
  ...
  intro: "Track sentencing patterns, incarceration incentives, prison pressures, and the systems that benefit from longer punishment.",
  tabs: [
    {
      id: "overview",
      label: "Overview",
      ...
      issues: [
        {
          id: "in_progress",
          label: "In Progress",
          title: "Criminal Justice: Sentencing & Prisons is being rebuilt",
