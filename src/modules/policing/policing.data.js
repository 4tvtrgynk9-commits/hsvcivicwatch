const data = {
  ...
  intro: "Track HPD, the Madison County Sheriff, patrol concentration, body cam access, lawsuits, and accountability gaps.",
  tabs: [
    {
      id: "overview",
      label: "Overview",
      ...
      issues: [
        {
          id: "in_progress",
          label: "In Progress",
          title: "Policing & Accountability is being rebuilt",
