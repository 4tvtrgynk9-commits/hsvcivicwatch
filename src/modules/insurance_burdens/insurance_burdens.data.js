const data = {
  ...
  intro: "Track rising health, dental, vision, home, and auto insurance burdens and who benefits from the price pressure.",
  tabs: [
    {
      id: "overview",
      label: "Overview",
      ...
      issues: [
        {
          id: "in_progress",
          label: "In Progress",
          title: "Insurance Burdens is being rebuilt",
