...
const OFFICIALS=[
  ...
  {level:"2026 Candidates",color:"#7c3aed",officials:[
    {name:"Tommy Tuberville",title:"Candidate — AL Governor 2026",district:"Statewide — running to replace term-limited Ivey",party:"Republican",since:"Announced Dec 2025",termEnds:"Would serve 2027-2031",avatar:"TT",salary:"$174,000/yr current Senate salary",netWorth:"Est. $11M–$33M",netWorthPre:"Est. $8M before Senate",netWorthHow:"Multi-million coaching contracts; hedge fund investments that raised ethics concerns while on Senate Armed Services Committee",residency:"Questions raised — Auburn AL listed but possible primary residence in Florida",criminal:"No criminal record",affiliation:"Republican; endorsed by Trump; former football coach",topDonors:[["Energy PACs","$270,000"],["Club for Growth","$185,000"],["Defense industry","$142,000"]],bio:"Current AL Senator running for Governor instead of Senate re-election. Introduced 21 bills in 4 years — zero advanced out of committee. Blocked 450+ military promotions for 10 months affecting Redstone Arsenal. Questions about whether he actually lives in Alabama full-time. If elected governor, would appoint ADEM leadership, parole board, and have power over Medicaid expansion that Ivey refused.",votes:[{bill:"Military promotions block",vote:"10 months",impact:"Directly disrupted Redstone Arsenal — then ran for governor of the state he disrupted"},{bill:"TVA oversight",vote:"None in 4 years",impact:"Received $270k energy PACs — introduced zero utility oversight"}],quotes:[
      ...
      {type:"general",quote:null,fact:"Introduced just 21 bills in the 118th Congress — zero of which advanced out of committee. Was spotted at the Masters Tournament instead of voting on a new Joint Chiefs chairman. Now running for governor claiming executive leadership experience.",date:"2023-2024",source:"Cook Political Report",flip:true},
      {type:"environment",quote:null,fact:"Received $270,000 from energy PACs as Senator. Introduced zero TVA oversight bills despite TVA raising rates 3 times in 18 months. As governor he would have no direct TVA authority — but AL Governor appoints ADEM leadership.",date:"2021-2025",source:"FEC.gov",flip:true},
    ],contact:{phone:"(202) 224-4124",web:"https://www.tuberville.senate.gov/contact",office:"455 Russell Senate Office Building"}},
    {name:"Doug Jones",title:"Candidate — AL Governor 2026 (Democrat)",district:"Statewide — former US Senator",party:"Democrat",since:"Announced 2025",termEnds:"Would serve 2027-2031",avatar:"DJ",salary:"N/A — private practice",netWorth:"Est. $2M–$5M",netWorthPre:"Est. $1.5M before Senate",netWorthHow:"Career as federal prosecutor and attorney; Senate salary 2018-2023",residency:"Birmingham, AL",criminal:"No criminal record — former federal prosecutor",affiliation:"Democrat; former US Senator (2018-2023); prosecuted 16th Street Baptist Church bombers",topDonors:[["Democratic fundraising network","Under research"],["Trial lawyers","Under research"]],bio:"Served as US Senator 2018-2023 — the only Democrat elected statewide in Alabama since 2008. Lost to Tuberville in 2020 by 20 points. Prosecuted the 16th Street Baptist Church bombers as US Attorney. If elected would be first Democratic governor since 1999. Would likely expand Medicaid immediately.",votes:[{bill:"ACA protection votes",vote:"Yes",impact:"Voted to protect pre-existing condition coverage"},{bill:"Bipartisan Infrastructure",vote:"Yes",impact:"Supported $1.2B for Alabama infrastructure"}],quotes:[
...
function OfficialsPage(){
  ...
  const levels=["All","Federal","State","County","Huntsville","2026 Candidates"];
