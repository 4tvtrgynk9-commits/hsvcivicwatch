...
```
      <main
        style={{
          minWidth: 0,
          /* FIX: added 18px left padding so content doesn't run flush against sidebar */
      ...
      {!mobileOpen && (
        <div
          style={{
            ...
            right: 0,
            zIndex: 70,
            /* FIX: use dark navy sidebar color instead of the cream page background */
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, minHeight: 42 }}>
            ...
            <div
              style={{
                ...
                fontWeight: 900,
                lineHeight: 1.15,
                /* FIX: use sidebar text color to be readable on dark background */
                color: COLORS.sidebarText,
                paddingRight: 4,
              }}
            >
