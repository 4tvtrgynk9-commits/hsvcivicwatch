...
const PAGES={
  equity:{icon:"⚖",title:"The Two Huntsvilles:",subtitle:"Service & Spending Inequality",tag:"tag-red",sub:"Roads PCI 41 north vs 72 south. Same taxes. $847/pupil school gap. 3.7× more police contacts per capita north. Who ...",
    ...
    facts:[
      {k:"red",label:"SCHOOL EQUITY: JEMISON HIGH vs COLUMBIA HIGH — SAME DISTRICT",lc:C.red,tc:"#7f1d1d",text:"J.O. Johnson High School closed in 2016 and was demolished in 2021. Its replacement, Mae C. Jemison High School (5000 Pulaski Pike, north Huntsville), now serves the same northwest Huntsville community. In 2023-2024, Jemison had a 44% Advanced Placement (AP) participation rate and 13 AP programs — but only 6-9% of students tested as proficient in math (vs. 29% state average). Columbia High (south Huntsville) offers 4 AP programs with 17% AP participation. Both schools serve 87-93% minority student populations. The underlying equity issue is the same: Huntsville City Schools has not adopted a weighted student funding formula to ensure lower-income schools receive sufficient resources to close documented outcome gaps."},
...
function EquityPage(){
  ...
  const metrics=[
    ...
    {label:"HCS AP Participation Rate",north:44,south:17,northLabel:"44% (Jemison)",southLabel:"17% (Columbia)",note:"Jemison: 13 AP programs, 44% participation. Columbia: 4 AP programs, 17% participation. Same district.",color:"#ea580c"},
  ...
  const investigations=[
    ...
    },
    {
      ...
      analysis:"NOTE: J.O. Johnson High School was closed in 2016 and demolished in 2021. Its replacement is Mae C. Jemison High School, serving northwest Huntsville. Any per-pupil spending figures cited from before 2016 for Johnson High are historical. Current verified data from the National Center for Education Statistics (2023-24): Jemison High has 13 Advanced Placement (AP) programs with 44% student participation — but only 6-9% of students test as math-proficient (vs. 29% AL average). Columbia High has 4 AP programs and 17% participation. Jemison ranks 170th in Alabama; Columbia ranks 199-297th. Both schools are in the same district with the same superintendent and board.\n\nThe structural problem is the same as it was: Huntsville City Schools does not use a weighted funding formula that would direct more resources to schools with higher proportions of economically disadvantaged students. 64% of Jemison students are economically disadvantaged. The district's $600M 10-year capital plan was announced in 2025-2026 — the question is whether north Huntsville schools receive equitable investment under it.\n\nBoard elections for Districts 2, 3, and 4 are on the November 2026 ballot — decided by under 200 votes at 11% turnout. Contact the HCS Board directly at (256) 428-6800 or attend board meetings at 200 White St. Demand a public breakdown of per-pupil resource allocation by school.",
      sources:[
