...
const PAGES={
  ...
  workers:{icon:"👷",title:"Workers Rights &",subtitle:"Child Care",tag:"tag-orange",sub:"$7.25/hr unchanged since 2009. Alabama banned cities from raising it. $14,400/yr for infant care — more than UAH tuition. What other states have done that Alabama refuses to.",
    ...
    facts:[{k:"red",label:"THE WAGE SUPPRESSION SYSTEM",lc:C.red,tc:"#7f1d1d",text:"In 2023 Arthur Orr sponsored SB 88 — banning Alabama cities from raising the minimum wage above the federal $7.25/hr floor. Huntsville cannot raise wages for its own workers. Madison cannot. Every Alabama city is locked to $7.25/hr unless the federal government acts. The Business Council of Alabama lobbied for SB 88 and donated $45,000 to Orr. Wage theft costs Alabama workers an estimated $180M/year — ADEM rarely investigates."},{k:"gold",label:"CHILD CARE: WHAT OTHER STATES HAVE DONE",lc:"#b8860b",tc:"#78350f",text:"Washington DC: publicly funded pre-K for all children from age 3. Vermont: Child Care Financial Assistance Program covers full cost for low-income families. Connecticut: Care 4 Kids subsidizes care from 6 weeks old. California: subsidized child care for families up to 85% of state median income. Georgia: universal pre-K for 4-year-olds since 1995 — fully funded. Alabama: ranked bottom 10 in pre-K access. No state-funded child care subsidy. Refused Summer EBT 2024."},{k:"blue",label:"WORKERS RIGHTS — WHAT ALABAMA BLOCKS",lc:"#2563eb",tc:"#1e3a5f",text:"Alabama has no state OSHA enforcement program — relies entirely on federal OSHA which is chronically understaffed. Alabama has no paid family leave law. No state earned sick leave requirement. No state EITC (Earned Income Tax Credit) for low-income workers. Alabama's unemployment benefits are among the lowest in the nation — $275/week maximum for 14 weeks. Orr's SB 88 preempts any local improvement."}],
  ...
  sentencing:{icon:"⚖",title:"Criminal Justice:",subtitle:"Courts, Jails & Prisons",tag:"tag-red",sub:"Kratom is a felony. Sitting in jail without a conviction because you can't afford bail. Life for stealing a bicycle. Private prisons paid per person donating to officials who block reform.", 75% of those sentenced to die in prison under HFOA are Black. Private prison companies donate to the officials maintaining every one of these laws.",
